...
export function buildRetirementPlan(input = {}) {
  ...
  return {
    ...
    disclaimer: "Educational guidance only. Results are hypothetical, sensitive to the values entered, and not guaranteed. Aigenikz does not provide fiduciary, tax, legal, or regulated investment advice.",
  };
}
