  ...
  return [
    {
      role: "system",
      content:
        "You are AstraMind Story Bible Architect. Return JSON only.",
    },
    {
      role: "user",
      content:
  ...
  return [
    {
      role: "system",
      content:
        "You are AstraMind Chapter Engine.\n" +
    ...
    [
      {
        role: "system",
        content:
          "You are AstraMind Polish Engine.\n" +
      ...
      [
        {
          role: "system",
          content:
            "You are AstraMind Research Engine. Build a sharp research summary with key findings, opportunity zones, warnings, and next-step recommendations.",
        },
        {
          role: "user",
          content:
      ...
      [
        {
          role: "system",
          content:
            "You are AstraMind Strategy Engine. Produce a business strategy scan with market angle, monetization routes, differentiation, risk review, and recommended launch steps.",
        },
        {
          role: "user",
          content:
      ...
      [
        {
          role: "system",
          content:
            "You are AstraMind SaaS Builder. Generate a SaaS blueprint with problem, ICP, feature stack, pricing, GTM, retention strategy, and MVP roadmap.",
        },
        {
          role: "user",
          content:
      ...
      [
        {
          role: "system",
          content:
            "You are AstraMind Content Engine. Build high-conversion content systems, platform plans, messaging angles, hooks, content pillars, and call-to-action structures.",
        },
        {
          role: "user",
          content:
      ...
      [
        {
          role: "system",
          content:
            "You are AstraMind Book Package Engine. Produce a full launch-ready book package with title logic, positioning, story/premise breakdown, audience angle, chapter arc overview, marketing angle, and next execution steps.",
        },
        {
          role: "user",
          content:
...
app.get("/api/health", (req, res) => {
  res.json({
    ok: true,
    service: "AstraMind Book Writer OS",
...
=============================== */
app.get("/", (req, res) => {
  res.send("AstraMind backend is live.");
});
...
async function bootstrap() {
  try {
    ...
    app.listen(PORT, () => {
      console.log("======================================");
      console.log("🚀 AstraMind FULL SYSTEM ONLINE");
