...
const EMPTY_ASSET = { name: "", assetType: "character", storageUri: "", mimeType: "", notes: "", parentAssetId: "", reusable: true, fileName: "", fileSize: 0, generatedBy: "", referenceAssetId: "", referenceStrength: 0.45, generationSeed: -1 };
...
export default function ProjectLibrary() {
  ...
  const generateAssetImage = async () => {
    ...
    try {
      ...
      const generated = await request("/api/ai-image/generate", { method: "POST", body: JSON.stringify({ prompt: subject, style: "cinematic anime fantasy", aspect: tab === "Characters" ? "portrait" : "landscape", seed: Number(assetForm.generationSeed), referenceImage: referenceAsset?.storageUri || null, referenceStrength: Number(assetForm.referenceStrength) }) });
