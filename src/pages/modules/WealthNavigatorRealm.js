    ...
    <main className="finance-module wealth-realm">
      <div className="finance-shell">
        <header className="finance-hero retirement-hero">
          <div className="finance-eyebrow">AstraMind Wealth Navigator · Retirement Guidance Contract</div>
          ...
          <div className="finance-safety"><strong>Guidance results are not guaranteed.</strong> Projections are hypothetical and highly sensitive to returns, inflation, fees, taxes, healthcare, longevity, benefit estimates, and the accuracy of your entries. AstraMind does not provide fiduciary, tax, legal, or regulated investment advice.</div>
        ...
        <section className="finance-grid">
          <article className="finance-card">
            ...
            <div className="finance-metric">{wealth.phase}<small>AstraMind priority route</small></div>
