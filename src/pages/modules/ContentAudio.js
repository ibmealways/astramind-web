// src/pages/modules/ContentAudio.js
  ...
  return (
    <div className="os-panel os-page-enter os-breathe w-full h-full p-6 text-white">
      <div className="max-w-5xl mx-auto bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-xl">
        <h1 className="text-3xl font-extrabold text-purple-200 mb-2">🎤 Audio Creator</h1>
        <p className="text-sm text-gray-300">Active placeholder — wire TTS / voice next.</p>
      </div>
    </div>
  );
}
